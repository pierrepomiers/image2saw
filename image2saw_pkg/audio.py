...
class Osc:
    ...
    amp: float = 1.0   # amplitude (0..1), par défaut pleine échelle
...
def render_audio(
    ...
    amp = np.array([getattr(o, "amp", 1.0) for o in oscs], dtype=np.float64)
